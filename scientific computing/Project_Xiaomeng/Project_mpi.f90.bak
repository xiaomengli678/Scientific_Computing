...
subroutine wave2d(E,H,s,kk,nx,ny,ierr, nprocs, myid)
  ...
  call allocate_via_subroutine(E,H,s,kk,nxl+1,ny,ierr,nprocs,myid,ix_off,hx,hy)

end subroutine wave2d
subroutine allocate_via_subroutine(E,H,s,kk,nx,ny,ierr,nprocs,myid,ix_off,hx,hy)
  use printble
  use wave2dh
  use mpi
  integer, intent(in) :: nx,ny,s,kk
  ...
  call printdble1d(x,nx,naming(strint("X_",myid),kk))
